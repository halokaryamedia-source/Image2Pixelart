<script lang="ts">
	...
	let { participants, deviceId, ownerDeviceId, activeEditorDeviceId, connectionState, requestingEdit, revision, onRequest, onCancelRequest, onGrant }: Props = $props();
