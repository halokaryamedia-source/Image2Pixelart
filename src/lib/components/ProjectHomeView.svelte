						...
						<button class="project-open" type="button" onclick={() => onOpen(project)}>
							...
							<div class="project-copy">
								...
								<div class="project-meta">
									<span><b>Canvas</b> {project.widthMm / 10} × {project.heightMm / 10} cm</span>
									<span><b>Grid Canvas</b> {project.columns} kolom × {project.rows} baris</span>
									<span><b>Ukuran 1 Tile</b> {project.cellMm / 10} × {project.cellMm / 10} cm</span>
								</div>
...
<style>
	.topbar{height:64px;padding:0 clamp(24px,4vw,64px);display:flex;align-items:center;border-bottom:1px solid var(--line);gap:34px;background:rgba(254,252,245,.94);position:sticky;top:0;z-index:30}.brand{display:flex;align-items:center;gap:12px;text-decoration:none;color:var(--ink);padding-right:32px;border-right:1px solid var(--line)}.brand img{width:36px;height:36px;image-rendering:pixelated}.brand>span{display:flex;flex-direction:column;line-height:1}.brand strong{font:700 17px "Readex Pro",sans-serif;letter-spacing:.12em}.brand small{margin-top:5px;font-size:7px;font-weight:800;letter-spacing:.16em}nav{margin-right:auto;height:100%;display:flex;align-items:center}nav a{height:100%;display:flex;align-items:center;color:var(--ink);font-size:14px;font-weight:650;text-decoration:none;border-bottom:2px solid var(--forest)}.secondary-button{min-height:44px;display:inline-flex;align-items:center;gap:9px;padding:0 15px;border:1px solid #d7d2c4;border-radius:8px;background:white;color:var(--ink);font-size:14px;font-weight:650;cursor:pointer}.secondary-button svg{width:19px;height:19px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linejoin:round}.device-button{min-height:38px;max-width:190px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:0 11px;border:1px solid #cfe0d6;border-radius:8px;background:#eef6f1;color:var(--forest);font-size:12px;font-weight:700}main{max-width:1440px;margin:auto;padding:34px clamp(24px,5vw,72px) 72px}.intro{margin-bottom:30px}.eyebrow{margin:0 0 9px;color:var(--accent-dark);font-size:11px;font-weight:800;letter-spacing:.14em}.intro h1{margin:0;font:700 clamp(36px,4vw,52px)/1.05 "Readex Pro",sans-serif;letter-spacing:-.045em}.intro h1 em{font-style:normal;color:var(--forest)}.intro>p:last-child{margin:10px 0 0;color:var(--muted);font-size:16px}.projects-heading{display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:16px}.projects-heading h2{margin:0;font:650 25px "Readex Pro",sans-serif;letter-spacing:-.035em}.projects-heading>span{color:var(--muted);font-size:13px}.empty{min-height:160px;border:1px dashed #cfc9b7;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:6px;padding:24px;text-align:center;color:var(--muted);font-size:14px}.project-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.project-grid article{position:relative;min-height:132px;border:1px solid #ddd8ca;border-radius:10px;background:#fff;box-shadow:0 7px 22px rgba(33,48,47,.05);transition:border-color .16s,box-shadow .16s,transform .16s}.project-grid article:hover{border-color:#b6c8bd;box-shadow:0 10px 26px rgba(33,48,47,.08);transform:translateY(-1px)}.project-open{width:100%;height:100%;display:grid;grid-template-columns:150px minmax(0,1fr);border:0;background:transparent;padding:0;text-align:left;color:inherit}.mini-mosaic{min-height:130px;overflow:hidden;border-radius:9px 0 0 9px;background:#eef0e9;display:grid;place-items:center}.project-copy{min-width:0;padding:15px 42px 13px 16px;display:flex;flex-direction:column}.project-title{display:flex;align-items:center;gap:8px;min-width:0}.project-title strong{min-width:0;font:650 15px "Readex Pro",sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.project-title span{flex:0 0 auto;color:var(--forest);font-size:10px;font-weight:700}.project-meta{margin-top:7px;display:flex;flex-wrap:wrap;column-gap:12px;row-gap:3px}.project-meta span{color:var(--muted);font-size:11px;line-height:1.45;white-space:nowrap}.project-meta b{color:var(--forest);font-weight:700}.project-copy>small{margin-top:5px;color:var(--muted);font-size:10px}.project-cta{margin-top:auto;padding-top:7px;color:var(--forest);font-size:12px}.project-cta i{margin-left:8px;font-style:normal}.menu-trigger{position:absolute;right:8px;top:8px;width:36px;height:36px;border:0;border-radius:7px;background:transparent;font-size:21px}.menu-trigger:hover{background:#f3f1e9}.project-menu{position:absolute;z-index:5;right:8px;top:44px;padding:6px;border:1px solid #d8d3c6;border-radius:8px;background:white;box-shadow:0 12px 28px rgba(31,43,36,.16)}.project-menu button{height:38px;border:0;background:transparent;color:var(--danger);font-size:12px;white-space:nowrap}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}@media(max-width:1050px){.project-grid{grid-template-columns:1fr}}@media(max-width:680px){.topbar{padding:0 16px;gap:12px}.brand{padding-right:0;border:0}.brand small,.topbar nav,.device-button{display:none}.secondary-button{margin-left:auto;font-size:0;width:44px;padding:0;justify-content:center}main{padding:24px 16px 56px}.intro h1{font-size:34px}.intro>p:last-child{font-size:14px}.projects-heading>span{display:none}.project-open{grid-template-columns:112px minmax(0,1fr)}.mini-mosaic{min-height:148px}.project-copy{padding:14px 34px 12px 12px}.project-meta{display:grid;gap:2px}.project-meta span{white-space:normal}}
</style>