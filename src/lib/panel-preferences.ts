...
export const EDITOR_PANEL_PREFERENCES_KEY = 'mivubi.editor.panels.v1';
export const DEFAULT_EDITOR_PANEL_PREFERENCES: EditorPanelPreferences = { left: true, right: true, quick: true };
